export function CallToActionSection() {
  return (
    <section className="py-20 w-full gap-5 px-30 bg-[#F8F9FA] flex flex-col items-center">
      <div className="bg-black rounded-3xl w-4/5 flex flex-col aspect-1024/380 relative isolate justify-center items-center p-10 text-center gap-5">
        <div className="absolute w-1/4 aspect-square rounded-3xl bg-yellow-300/25 blur-[100px] right-0 top-0"></div>
        <h2 className="max-w-[21ch] text-5xl font-bold text-white">
          Ready to automate your Slack workspace?
        </h2>
        <button className="bg-yellow-300 rounded-full px-5 py-2 cursor-pointer flex gap-3 items-center">

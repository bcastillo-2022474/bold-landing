...
export function SolutionSection() {
    const cards: Card[] = [
        ...
        },
        {
            ...
            description: "Request updates and new features anytime as your needs scale.",
            altImage: "Rocket img",
            image: RocketIcon
        },
        {
        ...
        <section className="grid grid-cols-2 items-center py-20 w-full gap-5 px-30 bg-[#F8F9FA]">
            <div className="flex flex-col gap-5 items-start">
                <div className="flex flex-col gap-1">
                    <h3 className="text-yellow-300 uppercase font-semibold">The Solution</h3>
                ...
                <button className="font-grotesk text-black bg-yellow-300 px-3 py-2 rounded-xl font-semibold">Explore our
                    process
                </button>
            </div>

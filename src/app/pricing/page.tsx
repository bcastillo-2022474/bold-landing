...
const plans = [
  {
    ...
    price: "$999",
    features: [
      "1 workflow automation activo",
      "Slack workspace setup",
      "1 integración (CRM o DB)",
      "Soporte async en Slack",
      "1 revisión/iteración por semana",
      "3 meses mínimo = $2,997 all-in",
    ],
    isPopular: false,
  },
  {
    ...
    price: "$1,999",
    features: [
      "Hasta 3 workflows activos",
      "Custom Slack app (básica)",
      "Hasta 2 integraciones",
      "AI agent simple (1 pipeline)",
      "Soporte async + 1 sync call/mes",
  ...
  },
  {
    ...
    price: "$5,999",
    features: [
      "Ecosistema de micro-apps",
      "AI agents custom + seguridad",
      "Integraciones ilimitadas",
      "Data real-time en Slack",
      "SLA + soporte 24/7",
      "Dedicated engineer",
      "Pausa o cancela cuando quieras",
    ],
